    ...
    <div>
        ...
        <div class="container">
            ...
            >
                ...
                <el-table-column prop="name" show-overflow-tooltip label="科目名称" header-align="center"></el-table-column>
                ...
                <el-table-column prop="type" label="考试形式" align="center" width="80"></el-table-column>
                 <el-table-column prop="majorName" label="所属专业" header-align="center"></el-table-column>
